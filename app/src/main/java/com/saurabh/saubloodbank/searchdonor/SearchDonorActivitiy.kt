package com.saurabh.saubloodbank.searchdonor
...
import com.saurabh.saubloodbank.bloodlist.BloodAdapter
import com.saurabh.saubloodbank.bloodlist.data.BloodEntity
import com.saurabh.saubloodbank.databinding.ActivitySearchDonorActivitiyBinding
...
class SearchDonorActivitiy : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        hall.addAll(resources.getStringArray(R.array.Center))
